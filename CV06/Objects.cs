...
namespace CV06
{
    internal class Circle : Object2D
    {
        ...
        {
            Console.WriteLine($"Circle, Radius = {radius}, Surface = {CalcSurface()}");
        }
    ...
    internal class Rectangle : Object2D
    {
        ...
        public override void Draw()
        {
            Console.WriteLine($"Rectangle, Length = {lenght}, Width = {width}, Surface = {CalcSurface()}");
        }
    ...
    internal class Ellipse : Object2D
    {
        ...
        public override void Draw()
        {
            Console.WriteLine($"Ellipse, A = {a}, B = {b}, Surface = {CalcSurface()}");
        }
        public override double CalcSurface()
        {
            return a * b * Math.PI;
